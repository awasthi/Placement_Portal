...
<body>
		...
		<h1> Resume</h1>
			...
			<label for="branch"> Branch </label> 
			 <input type="text" name="branch" id="branch" placeholder="eg. CS,EC "required> 
			</div>
		  
			<div>
			<label for="special"> Specialization </label>
			 <input type="text" name="special" id="special" placeholder="eg...S/W,ISR " required>
			</div>
		...
		<h3>Academic Qualifications </h3>
		    ...
		    <table>
			  ...
			  <tr>
			      <td> <input type="text" name="qualification1" placeholder="eg.. Integrated M.Tech/MBA"> </td>
			      <td> <input type="text" name="bu1" placeholder="GBU"> </td>
			      <td> <input type="text" name="percentage1" > </td>
	          	  </tr>
			  
			  <tr>
			      <td> <input type="text" name="qualification2" placeholder="Other Qualifications"> </td>
			      <td> <input type="text" name="bu2" > </td>
			      <td> <input type="text" name="percentage2" > </td>
	          	  </tr>
			  
			  <tr>
			      <td> <input type="text" name="qualification12" placeholder="Other Qualifications"> </td>
			      <td> <input type="text" name="bu12" > </td>
			      <td> <input type="text" name="percentage12"> </td>
	          	  </tr>
			  <tr>
			      <td>  12th </td>
			      <td> <input type="text" name="bu3" placeholder="eg... ISC,CBSE"> </td>
			      <td> <input type="text" name="percentage3"> </td>
			  </tr>
			  <tr>
			       <td>  10th </td>
                               <td> <input type="text" name="bu4" placeholder="eg...ICSE,CBSE"> </td>
		...
		<h3> Trainings Attended / Projects Undertaken </h3>
			...
			<input type="text" name="inten1" id="inten1" size="70"> 
			</div>

			<div>
		  	<label for="project1"> Project </label>
			<input type="text" name="project1" id="project1" size="70"> 
			</div>

			<div>
		  	<label for="inten1"> Internship </label>
			<input type="text" name="inten2" id="inten1" size="70"> 
			</div>

			<div>
		  	<label for="project1"> Project </label>
			<input type="text" name="project2" id="project1" size="70"> 
			</div>
			
		    	<div>
		  	<label for="inten1"> Internship </label>
			<input type="text" name="inten3" id="inten1" size="70"> 
			</div>

			<div>
		  	<label for="project1"> Project </label>
			<input type="text" name="project3" id="project1" size="70"> 
			</div>
		...
		<h2> Personal Details </h2>
		    ...
		    <input type="tel" name="mobile" required></div> 

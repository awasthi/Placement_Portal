...
<html>
	...
	<body>
		<header class="top">
			...
			<br>
                        <h3 id="headerText3"> Offered Job Opportunities </h3>
			
		</header> 
            <form method="post">
		<div id = "whole">
			 
		    <table id="delete_jobs">
			<br>
			    <tr>
			        <th> ID </th>
				<th> Title </th>
				...
				<th> </th>
                    ...
                    <tr>
                        <td width="100" align="center"> <s:property value="id" /></td>
                        <td width="150" align="center"> <s:property value="title" /></td>
                        <td width="150" align="center"> <s:property value="description" /></td>
                        <td width="150" align="center"> <s:a action="viewapplicants2"><s:param name="jobid" value="%{id}"/>VIEW APPLICANTS</s:a></td>
                    </tr>			
                </s:iterator>
		   </table>	
